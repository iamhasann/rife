                            ...
                            <li class="nav-item topbar-user dropdown hidden-caret">
                                <a
                                    ...
                                    <span class="profile-username">
                                        <span class="op-7">ผู้ปฏิบัติงาน,</span>
                                        <span class="fw-bold">อันวา</span>
                                    </span>
                                </a>
                                    ...
                                    <div class="dropdown-user-scroll scrollbar-outer">
                                        <li>
                                            <div class="user-box">
                                                ...
                                                <div class="u-text">
                                                    <h4>อันวา</h4>
                                                    <p class="text-muted">อันวา@example.com</p>
                                                    <a
                                                        href="../profile/"
                                        ...
                                        <li>
                                            ...
                                            <a class="dropdown-item" href="../../executive" aria-expanded="false">ออกจากระบบ</a>
                                        </li>
                                    </div>
                                </ul>
                            </li>
